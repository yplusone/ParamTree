...
db_info = {'server':"47.96.181.98",
            'pg':{
                  'username':"postgres",
                 'password':"postgres",
                 'port':58888,
                 'command_ctrl':"docker exec -it  --user postgres database ~/pgsql13.1/bin/pg_ctl -D ~/pgsql13.1_data"},
            'ssh' : {
                   'username':"root",
                 'password':"root",
                 'port':22
...
schema_db_info = {'server':"127.0.0.1",
            'pg':{
                 ...
                 'password':"",
                 'port':5434,
                 'command_ctrl':"~/pgsql13.1/bin/pg_ctl -D ~/pgsql13.1_data"}, #Command For database restart
            'ssh' : {
                   'username':"root",
                 'password':"root",        #user name and password for ssh login, with sudo permission
                 'port':22
            }
        }
